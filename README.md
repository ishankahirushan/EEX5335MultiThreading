...
- WSL2 provides a full Linux environment inside Windows.
- You can access WSL files from Windows:
  ```
...
- [Multithreading in Java – GFG](https://www.geeksforgeeks.org/java/multithreading-in-java/)
- [Multithreading in C – GFG](https://www.geeksforgeeks.org/c/multithreading-in-c/)
- [Operating System Concepts – Silberschatz et al.]
- [GitHub Repo](https://github.com/ishankahirushan/EEX5335MultiThreading)
...
- Practical implementation of multithreading in **C and Java**
- How threads can parallelize CPU-heavy tasks like matrix multiplication
- Effective use of **WSL2** for OS-level development without leaving Windows

> Parallelism significantly improves performance in matrix calculations and builds strong foundational skills in concurrency.
